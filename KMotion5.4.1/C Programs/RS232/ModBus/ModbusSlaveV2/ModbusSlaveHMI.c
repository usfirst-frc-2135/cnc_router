...
// Table consists of 3 values per entry
//
// first = offset from Modbus address 40001
// second = number of 16 bit Registers
// third = where to initially put the values in KFLOP

MemRange ReadWriteReg[]= // Modbus 4xxxx, function 0x03,0x06,0x10
{
	{0x0000,  0x10,  &MBRWRegisters[0x10]},	// HMI Register range 40001-40017, int16 range
	{0,0,0} // end flag
};
