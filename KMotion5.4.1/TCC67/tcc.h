...
typedef struct SValue {
    CType type;      /* type */
    int r;      /* register + flags */  // was short
    int r2;     /* second register, used for 'long long'  // was short
...
TokenSym *tok_alloc(const char *str, int len);  //  these are now used by C67 code gen
void vpush_global_sym(CType *type, int v); //  these are now used by C67 code gen
