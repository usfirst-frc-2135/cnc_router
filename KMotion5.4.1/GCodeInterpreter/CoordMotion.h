...
public:
	...
	int MeasurePointAppendToFile(const wchar_t *name);
	...
	int CheckLimit(int axis, double Act, double SoftLimitPos, double SoftLimitNeg, wchar_t Name, CString &errmsg);
	...
	wchar_t MainPath[MAX_PATH],MainPathRoot[MAX_PATH];
