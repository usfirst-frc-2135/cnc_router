...
CCoordMotion::CCoordMotion(CKMotionDLL *KM)
{
	...
	if (f)
	{
		...
		if (wcsstr(s, L"5AxisTableAC") != NULL)
			Kinematics = new CKinematics5AxisTableAC;
		else if (wcsstr(s, L"Kinematics5AxisTableAB") != NULL)
			Kinematics = new CKinematics5AxisTableAB;
		else if (wcsstr(s, L"5AxisTableBC") != NULL)
			Kinematics = new CKinematics5AxisTableBC;
		else if (wcsstr(s, L"Kinematics5AxisTableAGimbalB") != NULL)
			Kinematics = new CKinematics5AxisTableAGimbalB;
		else if (wcsstr(s, L"5AxisGimbalAB") != NULL)
			Kinematics = new CKinematics5AxisGimbalAB;
		else if (wcsstr(s, L"5AxisGimbalCB") != NULL)
			Kinematics = new CKinematics5AxisGimbalCB;
		else if (wcsstr(s, L"GeppettoExtruder") != NULL)
