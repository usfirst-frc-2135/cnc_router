// KinematicsGeppetto.cpp: implementation of the CKinematicsGeppetto class.
//
//////////////////////////////////////////////////////////////////////
...
CKinematicsGeppetto::CKinematicsGeppetto()
{
...
void CKinematicsGeppetto::Rotate(double xc,double yc,double zc,double z,double a,double b,
...
void CKinematicsGeppetto::Rotate3(double xc,double yc,double zc,double x,double y,double z,double a,double b,double c,
								double *xp,double *yp,double *zp)
{
	double ar=a*PI/180.0;
	double br=b*PI/180.0;
...
int CKinematicsGeppetto::TransformCADtoActuators(double x, double y, double z0, double a, double b, double c, double *Acts, bool NoGeo)
{
...
int CKinematicsGeppetto::InvertTransformCADtoActuators(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
	double Tol=1e-6;
...
int CKinematicsGeppetto::TransformActuatorstoCAD(double *Acts, double *xr, double *yr, double *zr, double *ar, double *br, double *cr, bool NoGeo)
{
...
int CKinematicsGeppetto::ReadGeoTable(const char *name)
{
	double X, Y, Z, c;
	int row, col;
...
int CKinematicsGeppetto::GeoCorrect(double x, double y, double z, double a, double b, double c, 
...
int CKinematicsGeppetto::GetSoftLimits(double *xm, double *xp, double *ym, double *yp, double *zm, double *zp,
