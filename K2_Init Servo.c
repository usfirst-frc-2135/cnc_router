...
void init_board()
{
	...
	chan[PortArray[0]].BacklashAmount = 10; // Attempt to correct backlash in X axis of 0.003 in.
	chan[PortArray[0]].BacklashRate = 208;	// Attempt to correct backlash in X axis of 0.003 in.
#endif
	...
	chan[PortArray[1]].BacklashAmount = 30; // Attempt to correct backlash in X axis of 0.003 in. in counts
	chan[PortArray[1]].BacklashRate = 608;	// Attempt to correct backlash in X axis of 0.003 in. counts/sec
#endif
