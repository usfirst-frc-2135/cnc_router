...
void init_board()
{
		...
		chan[PortArray[0]].Accel=200000.0;
		chan[PortArray[0]].Jerk=600000.0;

		if	(notset == 0)
		{
			persist.UserData[3*PortArray[0]+1]=0.250*1000000; //p
			persist.UserData[3*PortArray[0]+2]=0.00001*1000000;//i
			persist.UserData[3*PortArray[0]+3]=0.0001*1000000;//d
		}
		...
		chan[PortArray[0]].FFVel=0.001000;
	...
	//-----------------------
		...
		chan[PortArray[1]].Accel=200000.0;
		chan[PortArray[1]].Jerk=600000.0;

		if	(notset == 0)
		{
			persist.UserData[3*PortArray[1]+1]=0.250*1000000; //p
			persist.UserData[3*PortArray[1]+2]=0.00001*1000000;//i
			persist.UserData[3*PortArray[1]+3]=0.0001*1000000;//d
		}
		...
		chan[PortArray[1]].FFVel=0.0010000;
	...
	//-----------------------
		...
		if	(notset == 0)
		{
			persist.UserData[3*PortArray[2]+1]=0.350*1000000; //p
			persist.UserData[3*PortArray[2]+2]=0.00001*1000000;//i
			persist.UserData[3*PortArray[2]+3]=0.0001*1000000;//d
		}
		...
		chan[PortArray[2]].FFVel=0.001000;
	...
	//-----------------------
		...
		chan[PortArray[3]].Accel=200000.0;
		chan[PortArray[3]].Jerk=600000.0;
		
		if	(notset == 0)
		{
			persist.UserData[3*PortArray[3]+1]=0.250*1000000; //p
			persist.UserData[3*PortArray[3]+2]=0.00001*1000000;//i
			persist.UserData[3*PortArray[3]+3]=0.0001*1000000;//d
		}
		...
		chan[PortArray[3]].FFVel=chan[PortArray[1]].FFAccel;
